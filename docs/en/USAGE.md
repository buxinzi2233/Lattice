...
"Reveal full log" selects the persistent log in the file manager. "Clear view" only clears the window buffer. Interface text scales from 80% to 150%. Settings switch immediately between the Lattice Day and Lattice Night packs.
